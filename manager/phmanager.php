...
<body>
    ...
    <section id="main-content">
        ...
        <div class="dddd">
            ...
            <div class="aaa">
                <h3>List</h3>
                <input type="text" id="ser" name="search_user" placeholder="Search by Username" required>
            ...
            <?php
             ...
             $k=0;
              ...
              {
                $sql="select * from `chk_in` where Parking_zoon='$pa_area'";
            ...
            ?>
             <?php
            $sql="select * from `chk_out` where Parking_zoon='$pa_area'";

...
<body>
    ...
    <section id="main-content">
        ...
        <div class="dddd">
            ...
            {
                $ser=$_POST['search'];
                $sql="SELECT * FROM `add_manager` WHERE username LIKE '%$ser%'";
                $ser=null;
            }else
            $sql="SELECT * FROM `add_manager` WHERE User_type='Manager'";
            ...
            <tr>
                ...
                <td style="height:40px;width:40px;"><?php echo"<img src='images/$image' style='height:40px;width:40px;'>";?></td>
                <td><?php echo $row['first_name']; ?></td>
                <td><?php echo $row['phone_number']; ?></td>
                <td><?php echo $row['add_date']; ?></td>
                <td><?php echo $row['username']; ?></td>
                <td><button class="edit"><a href='edit.php? un=<?php echo $row['username']; ?>' style='color:white;'>Edit</a><button></td>
                <td><button class="delete"><a href="delete.php? un=<?php echo $row['username']; ?>" style='color:white;'>Delete</a></button></td>
            </tr>
            <?php
            }
            }        
